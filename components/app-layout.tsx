...
import { BarChart3, CreditCard, LogOut, Menu, MessageSquare, Settings, User } from "lucide-react"
        ...
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <Sheet>
              ...
              <SheetContent side="left" className="w-64 gradient-dark border-r-0">
          ...
          <div className="flex items-center gap-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56 mt-1 rounded-xl" align="end" forceMount>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="rounded-lg cursor-pointer transition-colors hover:bg-accent">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem className="rounded-lg cursor-pointer transition-colors hover:bg-destructive/10 hover:text-destructive">
